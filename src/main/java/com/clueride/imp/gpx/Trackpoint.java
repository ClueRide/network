...
public class Trackpoint implements PointWithElevation {
    ...
    public double getDistance(Trackpoint trackpoint) {
        double distance = Math.acos(Math.sin(this.latDouble * 0.017453292519943295D) * Math.sin(trackpoint.getLatDouble() * 0.017453292519943295D) + Math.cos(this.latDouble * 0.017453292519943295D) * Math.cos(trackpoint.getLatDouble() * 0.017453292519943295D) * Math.cos(trackpoint.getLonDouble() * 0.017453292519943295D - this.lonDouble * 0.017453292519943295D));
    ...
    public String toString() {
        ...
        retValue.append("\nTrackpoint ( ").append("latDouble = ").append(this.latDouble).append("  ").append("lonDouble = ").append(this.lonDouble).append("  ").append("altitude = ").append(this.altitude).append("  ").append(" )");
